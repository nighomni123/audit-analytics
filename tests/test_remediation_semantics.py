...
class RemediationSemanticsTest(unittest.TestCase):
    def test_fiscal_period_window_includes_preceding_days_and_excludes_future_days(self):
        ...
        reasons, _, _, _, _ = _calculate_signals(entries, {"round_amount_threshold": 1000, "period_end_days": 3}, __import__("datetime").date(2026, 3, 31), ["2026-03-31", "2026-09-30"], {}, False)
    ...
    def test_missing_identity_is_not_a_rare_preparer_pair(self):
        ...
        reasons, evidence, _, _, _ = _calculate_signals(entries, {"round_amount_threshold": 1000, "period_end_days": 3}, __import__("datetime").date(2026, 3, 31), [], {}, False)
